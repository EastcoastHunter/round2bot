...
async def on_message(message):
    ...
    if message.content.lower().startswith(prefix + 'tickets'):
        ...
        await client.send_message(
            ...
            "https://discordapp.com/oauth2/authorize?client_id=527193249149091880&scope=bot&permissions=8"
        )
        ...
        infotext = discord.Embed(
            title="D.E.S Support Bot",
            description="About the bot.",
            color=0x37ceb2,
            url="https://infusion-productions.bubbleapps.io"
        )
        infotext.set_author(
            name="Hunter L | Hunter L#3037",
            url="https://github.com/OwnerHunter",
            icon_url="https://media.discordapp.net/attachments/527195696894443520/527198132635959306/Instagram_georgia_police_fire_pictures_46667603_2414739845207252_1253378274557463125_n.jpg?width=400&height=291"
        )
        infotext.set_thumbnail(
            url="https://media.discordapp.net/attachments/527195696894443520/527198053560614924/Instagram_west_coast_emergency_pics_47690548_270157380519108_6610178025734863471_n.jpg?width=312&height=300"
        )
        infotext.add_field(
            name="Developer",
            value="Name: **Hunter L**\n"
                  "Discord: **Hunter L #3037**\n"
                  "GitHub: [Owner Hunter](https://github.com/OwnerHunter)\n"
                  "You Can Join My by [**clicking here**](https://discord.gg/J7qXTMP).\n"
                  "***This was a very complex build***",
            inline=True
        )
        infotext.add_field(
            name="Developed in:",
        ...
        infotext.add_field(
            ...
            value="Type `{0}help` to get all commands.\n"
                  "Join the [Official Support Server](https://discord.gg/J7qXTMP) "
        ...
        infotext.set_footer(
            text="©2018 Hunter L and Infusion productions L.L.C"
        )
...
client.run('NTI3MTkzMjQ5MTQ5MDkxODgw.DwQKkw.pGangHEVXntD6opNq55xzqPnpT0')  # TODO: insert token
